// ---------------------------------------------------------------
// raw_data_3_limb.ino
// Reads raw accelerometer and gyroscope data from THREE MPU-9250s
// through a TCA9548A I2C multiplexer and prints one line per sample:
//
//    ax1,ay1,az1,gx1,gy1,gz1,ax2,...,gz2,ax3,...,gz3
//
// (18 comma-separated values: IMU 1 = mux channel 0,
//  IMU 2 = channel 1, IMU 3 = channel 2)
//
// Wiring (Arduino Uno):
//    Uno A5  -> TCA9548A SCL
//    Uno A4  -> TCA9548A SDA
//    Uno 5V  -> TCA9548A VIN and each IMU VCC
//    Uno GND -> TCA9548A GND and each IMU GND
...
const int NUM_IMUS = 3;         // on mux channels 0, 1, 2
...
void loop() {
  // Read all three IMUs in turn and build one long line.
  for (int i = 0; i < NUM_IMUS; i++) {
    muxSelect(i);
